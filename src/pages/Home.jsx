          ...
          <header className="flex items-center p-4 pb-2 justify-between bg-white sticky top-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-bold text-gray-900 text-lg">Liam</p>
              </div>
            </div>
            <button className="flex h-10 w-10 cursor-pointer items-center justify-center overflow-hidden rounded-full text-gray-600">
